		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE COMANDO É ESPECÍFICO PARA USUARIO MOD EREN BOT',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] Proprietário? Este comando só pode ser usado pelo Gaarazinho',
					ownerB: '[❗] Proprietário? Este comando só pode ser usado pelo Gaarazinho',
...
const get = require('got')
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("dudenha")){
			client.updatePresence(from, Presence.composing)
			reply("preta KKKKKK️")
	}		
		if (messagesC.includes("lari")){
			client.updatePresence(from, Presence.composing)
			reply("a melhor sem dúvidas ☝️")
	}	
...
//msc fim
			...
			switch(command) {
				case 'help':
				case 'menu':
				menuimg = fs.readFileSync('./assets/imgmenu.jpg')
					client.sendMessage(from, menuimg, image, {quoted: mek, caption: help(prefix), text})
					break			
				case 'help1':
				case 'menu1':
...
// recursos anime, random @dark domina vida
          ...
          reply('Espere..')
                ...
                case 'eren':
                    client.updatePresence(from, Presence.composing)
                    co = ["Eren Yeager","Eren Yeager Instagram","Eren Yeager pins","Eren Yeager pinterest"]
